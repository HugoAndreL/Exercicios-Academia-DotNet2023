...
namespace Amigo_Secreto
{
    public class Friend
    {
        ...
        // Créditos ao Programação Plena e a documentação do github https://github.com/ricardosma/academia_DotNet_5/blob/main/02-conteudo-aula/Serializa%C3%A7%C3%A3o.pdf
