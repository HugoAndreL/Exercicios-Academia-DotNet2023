namespace Amigo_Secreto
{
    partial class frmAmigoSecreto
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvLst.BackgroundColor = SystemColors.Info;
            dgvLst.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvLst.Columns.AddRange(new DataGridViewColumn[] { nameDataGridViewTextBoxColumn, emailDataGridViewTextBoxColumn });
