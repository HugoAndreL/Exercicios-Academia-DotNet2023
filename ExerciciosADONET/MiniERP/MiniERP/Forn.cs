...
namespace MiniERP
{
    public partial class Forn : Form
    {
        ...
        {
            BD bd = new();
            string sql = "SELECT id AS 'ID', nome AS 'Nome', cnpj AS 'CNPJ', funcao AS 'Função', datCriacao AS 'Data de Criação' FROM Fornecedores";
            DataTable dt = new();
        ...
        private void Search(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Fornecedor encotrado: \n" +
                $"{forn.nome}, {forn.cnpj}, {forn.func}, {forn.datCriacao}", "ENCONTRADO", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
